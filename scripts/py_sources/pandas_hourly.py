...
def pandasJsonNormalizeHourly(dataRaw, html=False, excel=False, limit=0):
    ...
    if 'hourly_stats_aggregated_by_advertiser_time_zone' in cols:
        cols.insert(index, cols.pop(cols.index('hourly_stats_aggregated_by_advertiser_time_zone')))
        index += 1
        column_sort.append('hourly_stats_aggregated_by_advertiser_time_zone')
